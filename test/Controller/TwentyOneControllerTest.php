 ...
 */
class TwentyOneControllerTest extends TestCase
{
    /**
    ...
    public function testCreate()
    {
        ...
        $http = new MockHttpClient();
        $controller = new TwentyOneController($util, $session, $http);
        $this->assertInstanceOf("\pereriksson\Controllers\TwentyOneController", $controller);
    }
